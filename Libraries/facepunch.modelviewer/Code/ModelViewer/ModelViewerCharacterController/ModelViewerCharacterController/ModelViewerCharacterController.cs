...
[Title( "Model Viewer Character Controller" )]
[Category( "Physics" )]
[Icon( "directions_walk", "red", "white" )]
[EditorHandle( "materials/gizmo/charactercontroller.png" )]
public class ModelViewerCharacterController : Component
{
	[Range( 0, 200 )]
	...
	void Move( bool step )
	{
		...
		var mover = new ModelViewerCharacterControllerHelper( BuildTrace( pos, pos ), pos, Velocity );
		mover.Bounce = 0.3f;
	...
	public PhysicsTraceResult LastPhysicsTrace;
	...
	public void MoveTo( Vector3 targetPosition, bool useStep )
	{
		...
		var mover = new CharacterControllerHelper( trace, pos, delta );
		mover.MaxStandableAngle = GroundAngle;
