...
internal struct ModelViewerCharacterControllerHelper
{
	//
	// Inputs and Outputs
	//
	...
	public ModelViewerCharacterControllerHelper( PhysicsTraceBuilder trace, Vector3 position, Vector3 velocity ) : this()
	{
		Velocity = velocity;
		Position = position;
		Bounce = 0.0f;
