...
internal static class MovieBlockExtensions
{
	...
	public static IEnumerable<PropertyBlockSlice> Slice( this ProjectTrack track, MovieTimeRange timeRange ) =>
		track.GetCuts( timeRange ).Select( x => x.Block.Slice( x.TimeRange ) );

	public static PropertyBlockSlice Slice( this IBlock srcBlock, MovieTimeRange timeRange ) =>
