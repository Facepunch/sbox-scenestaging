...
partial class MovieTargets
{
	...
	/// set the property value to whatever value is stored in that track at the given <paramref name="time"/>.
	/// </summary>
	private void ApplyFrame( MovieClip clip, MovieTrack track, MovieTime time )
	{
		...
		foreach ( var child in clip.GetChildren( track ) )
		{
			ApplyFrame( clip, child, time );
		}
	}
	...
	/// </summary>
	public void ApplyFrame( ITrackDescription track, IMovieBlock block, MovieTime time )
	{
